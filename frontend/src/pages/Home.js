...
const Home = () => {
  // return (
  //   <div>
  //     <h1>Welcome to the FreeCodeCamp!</h1>
  //     <p>
  ...
  return (
    <div className="home-container">
      ...
      {/* <div className="logo-container">
        <svg id="apple-logo" viewBox="450 0 500 650"
          xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="var(--quaternary-color)"
          role="img" aria-labelledby="apple-logo-label" className="company-logo">
